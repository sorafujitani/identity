...
- Brain vault path: `/Users/fujitanisora/brain/`
- Use Glob/Grep only for **codebase verification**, not for reading /Users/fujitanisora/brain/skill files
...
**Inputs:** brain snapshot, skills snapshot (`/tmp/skills-snapshot.md`), auditor report, `/Users/fujitanisora/brain/principles.md`.
...
- Each proposed principle: insight, evidence (which notes), why independent, suggested path under `/Users/fujitanisora/brain/principles/`
