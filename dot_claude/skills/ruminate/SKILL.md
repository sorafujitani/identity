...
Build a brain snapshot: `sh /Users/fujitanisora/.claude/skills/meditate/scripts/snapshot.sh /Users/fujitanisora/brain/ /tmp/brain-snapshot-ruminate.md`. Pass the snapshot path to each analysis agent. This avoids loading the full brain into the ruminate orchestrator's context.
...
```bash
python3 /Users/fujitanisora/.claude/skills/ruminate/scripts/extract-conversations.py "$CONV_DIR" "$OUT_DIR" --batches N
```
...
- Update `/Users/fujitanisora/brain/index.md` after all changes
