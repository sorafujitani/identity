...
Read `/Users/fujitanisora/brain/principles.md`. Follow every `[[wikilink]]` and read each linked principle file. These principles govern review judgments — refer back to them when evaluating issues.
...
Check installed skills (`/Users/fujitanisora/.claude/skills/`, `.claude/skills/`) for any that match the review's domain.
