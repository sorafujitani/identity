...
name: brain
description: >-
  Read/write brain files (Obsidian vault at /Users/fujitanisora/brain/). Use for any task that persists knowledge —
  reflection, planning, or direct edits. Triggers: /Users/fujitanisora/brain/ modifications, "add to brain".
---

# Brain

Persistent memory across sessions. Obsidian vault at `/Users/fujitanisora/brain/`.
...
Read `/Users/fujitanisora/brain/index.md` first. Then read the relevant entrypoint for your topic:

- `/Users/fujitanisora/brain/principles.md` for principle updates
...
- One topic per file. `/Users/fujitanisora/brain/codebase/deploy-gotchas.md`, not a mega-file.
- Maintain existing index entrypoints: `/Users/fujitanisora/brain/index.md`, `/Users/fujitanisora/brain/principles.md`.
- If you introduce a new top-level category, add an index-style entrypoint for it (links only, no inlined content).
- `/Users/fujitanisora/brain/index.md` is the root. Every brain file must be reachable from it.
...
Update `/Users/fujitanisora/brain/index.md` for any files you added or removed. Also update the relevant entrypoint when applicable. Keep indexes link-only and scannable.

## Durability Test

Ask: "Would I include this in a prompt for a *different* task?"

- **Yes** -> write to `/Users/fujitanisora/brain/`. It's durable knowledge.
